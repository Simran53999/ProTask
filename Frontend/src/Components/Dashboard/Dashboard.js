...
useEffect(() => {
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}/task/getAllTask/${props.username}`
      )
      .then((res) => {
  ...
  useEffect(() => {
    ...
    if (myTaskStatType === "Progress") {
      ...
      tmp.sort(function (a, b) {
        ...
        var d11 = new Date(a.startDate),
          d12 = new Date(a.endDate);
        if (b.endDate === null || b.startDate === null) {
          return -1;
        }
        var d21 = new Date(b.startDate),
          d22 = new Date(b.endDate);
      ...
      tmp.map((element, index) => {
        if (element.startDate === null || element.endDate === null) {
          ...
          var d = new Date();
          d = d.getTime();
          var d11 = new Date(element.startDate),
            d12 = new Date(element.endDate);
  ...
  useEffect(() => {
    ...
    if (assTaskFilterType === "") {
      tmp = allTasks.filter((element) => {
        if (
          element.assignedTo !== props.username &&
          element.assignedBy === props.username
        )
          return element;
      });
    } else {
      tmp = allTasks.filter((element) => {
        if (
          element.assignedTo === assTaskFilterType &&
          element.assignedBy === props.username
        )
          return element;
      });
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-myTask">
        <div className="dashboard-myTask-statOps">
          <div
            className={`dashboard-statOps-ops ${
              myTaskStatType === "Progress" ? "statOps-selected" : ""
            }`}
          ...
          <div
            className={`dashboard-statOps-ops ${
              myTaskStatType === "ExpectedEndDate" ? "statOps-selected" : ""
            }`}
          ...
          <div
            className={`dashboard-statOps-ops ${
              myTaskStatType === "Ratio" ? "statOps-selected" : ""
            }`}
      ...
      <div className="dashboard-assTask">
        <div className="dashboard-assTask-statOps">
          <div
            className={`dashboard-statOps-ops ${
              assTaskStatType === "Progress" ? "statOps-selected" : ""
            }`}
          ...
          <div
            className={`dashboard-statOps-ops ${
              assTaskStatType === "ExpectedEndDate" ? "statOps-selected" : ""
            }`}
          ...
          <div
            className={`dashboard-statOps-ops ${
              assTaskStatType === "Ratio" ? "statOps-selected" : ""
            }`}
